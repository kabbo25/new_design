...
class EditNotesModal extends StatelessWidget {
  ...
  Widget _buildEditButton(BuildContext context, Note note) {
    return TextButton(
  ...
  Widget _buildNoteItem(BuildContext context, Note note, double opacity) {
    return Container(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Divider(),
          const Gap(10),
          AnimatedScrollList<Note>(
            items: notes,
            maxHeight: MediaQuery.of(context).size.height * 0.20,
            itemHeight: 50,
            debug: true,
            itemBuilder: (note, opacity) =>
                _buildNoteItem(context, note, opacity),
          ),
          Padding(
